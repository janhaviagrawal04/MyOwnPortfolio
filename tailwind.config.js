  ...
  theme: {
    extend: {
      ...
      backgroundImage:{
        ...
        circularDarkSm : 'repeating-radial-gradient(rgba(255,255,255,0.5) 2px, #1b1b1b 5px, #1b1b1b 60px);',
        circularLightXs : 'repeating-radial-gradient(rgba(0,0,0,0.4) 2px, #f5f5f5 5px, #f5f5f5 40px);',
        circularDarkXs : 'repeating-radial-gradient(rgba(255,255,255,0.5) 2px, #1b1b1b 5px, #1b1b1b 40px);',
      }
    },
    screens: {
      "2xl": { max: "1535px" },
